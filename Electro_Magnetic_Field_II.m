...
function[Ez,Bx,By,pulse,iterations]=Electro_Magnetic_Field_II(length,nofe,c,totaltime,disturbance_time,disturbance_type,A,w,draw_disturbance,F_mask,Plot_or_not,boundary,rotate,az_user,el_user,pause_or_not)
        %create a 2D mesh
